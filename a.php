            ...
            <li class="hs-has-sub-menu nav-item">
              ...
              <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="pagesMegaMenu"
                ...
                <div class="hs-has-sub-menu nav-item">
                  ...
                  <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless" aria-labelledby="usersMegaMenu"
                    style="min-width: 14rem;">
                ...
                <div class="hs-has-sub-menu nav-item">
                  ...
                  <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless"
                    ...
                    <!-- Reset Password -->
                    <div class="hs-has-sub-menu nav-item">
                      <a id="resetPasswordMegaMenu" class="hs-mega-menu-invoker dropdown-item dropdown-toggle " href="#"
      ...
      <div class="row justify-content-lg-center pt-lg-5 pt-xl-10">
        <div class="col-lg-9">
          ...
          <div class="text-center">
            <img class="img-fluid mb-5" src="assets/svg/layouts/header-double-line-container.svg"
              alt="Image Description" data-hs-theme-appearance="default" style="max-width: 15rem;">
            <img class="img-fluid shadow-sm mb-5" src="assets/svg/layouts-light/header-double-line-container.svg"
